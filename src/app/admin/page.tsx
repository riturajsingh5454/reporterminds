  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
        <StatCard label="Visitors (14d)" value={stats.totalVisitors} icon={Users} />
        ...
        <StatCard label="Subscribers" value={stats.subscribersCount} icon={Mail} />
        <StatCard label="New Inquiries" value={stats.newContactsCount} icon={Inbox} />
      </div>
